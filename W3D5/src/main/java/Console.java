 ...
 * @author levi 
 * 
 * This class is a "desktop" (command line) UI of the quiz lab. It
 * uses the exact same classes for the business logic as the web
 * application.
 */
    ...
    public static void main(String[] args) {
        try {
            ...
            while (questionsLeft) { // They have to keep trying until get the right number.
                ...
                System.out.println("Next sequence is:  " + quiz.getCurrentQuestionIndex());
                ...
                if ((answer != null) && quiz.isCorrect(Integer.parseInt(answer))) {
                    error = false;
                    quiz.scoreAnswer();
                }
